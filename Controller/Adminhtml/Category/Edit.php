...
class Edit extends \Osc\Sample\Controller\Adminhtml\Category
{
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create(\Osc\Sample\Model\Category::class);
        ...
        $this->_coreRegistry->register('osc_sample_category', $model);
